...
const MOCK_QUEUE: Order[] = [
	{
		...
		files: [
			{
				id: "file-1",
				originalName: "Semester_Notes_Final.pdf",
				copies: 3,
				colorMode: "BW",
				status: "PENDING",
				pageCount: 12,
	...
	},
	{
		...
		files: [
			{
				id: "file-2",
				originalName: "Company_Brochure_v3.pdf",
				copies: 1,
				colorMode: "COLOR",
				status: "PRINTING",
				pageCount: 4,
	...
	},
	{
		...
		files: [
			{
				id: "file-3",
				originalName: "Assignment_Physics.pdf",
				copies: 2,
				colorMode: "BW",
				status: "COMPLETED",
				pageCount: 8,
...
export default function HomePage() {
	...
	function handleOrderSubmitted(
		files: { name: string; copies: number; colorMode: "BW" | "COLOR" }[],
	) {
	...
	return (
		<div className="min-h-screen bg-white text-[#1A1A1A] font-sans selection:bg-[#D97706] selection:text-white relative">
			...
			<section
				id="simulator"
				className="relative -mt-10 sm:-mt-14 py-24 bg-[#F2EFE9]"
			>
				<div className="max-w-7xl mx-auto px-6 lg:px-12">
					<div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
						...
						<p className="text-gray-600 font-sans-clean text-base">
							Submit a sample order on the left and watch it
							appear in the order queue on the right — the same
							interface real shop owners use.
						</p>
					</div>
